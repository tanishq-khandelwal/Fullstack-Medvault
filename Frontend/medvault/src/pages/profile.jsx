...
const Profile = () => {
  ...
  // State for save button activation
      ...
      <div className="pt-5 w-full h-full flex justify-center items-center">
        <div className="w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%] xl:w-[30%] flex flex-col items-center gap-6 bg-blue-100 rounded-3xl p-10 shadow-xl border border-[#82818166]" >
          ...
          <div className="flex w-full justify-center">
            <p>Status:</p>
            <input type="checkbox" className="toggle toggle-success ml-10"  checked={status === "Available"} onChange={handleToggleStatus}/>
          </div>
          <button
            className={`bg-red-700 text-white px-6 py-2 rounded-md ${saveEnabled ? "" : "opacity-50 cursor-not-allowed"}`}
            onClick={handleSave}
